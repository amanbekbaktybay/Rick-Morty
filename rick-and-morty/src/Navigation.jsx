        ...
        <div className="wrapper">
                <div className="navigation">
                    <div className="navigation__wrapper">
                        <svg width="24" height="24" viewBox="0 0 24 24" className="navigation__characters navigation-icon"   xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h5 className="navigation__title selected">Персонажи</h5>
                    </div>
                    <div className="navigation__wrapper">
                        <img src="assets/location-icon.svg" alt="" className="navigation__location navigation-icon"/>
                        <h5 className="navigation__title">Локации</h5>
                    </div>
                    <div className="navigation__wrapper">
